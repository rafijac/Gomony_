...
export const GameProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <GameContext.Provider value={{
      board, currentPlayer, pendingJump, moveStack, triggerAIMove, resetGame,
      lastMessage, gameMode, setGameMode, isThinking, setIsThinking,
      playerNumber, orientation, sessionToken, gameId, setMultiplayerSession,
      currentTurnColor, startingColor, yourColor, sessionExpired, setSessionExpired,
      setBoardStateFromAI,
    }}>
      {children}
